...
namespace StonePizza.Data.Migrations
{
    ...
    [Migration("20200303021652_intialModelDesign")]
    partial class intialModelDesign
    {
            ...
            modelBuilder.Entity("StonePizza.Models.PizzaTopping", b =>
                {
                    ...
                    b.Property<int?>("SignaturePizzaPizzaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SignaturePizzaPizzaId");
            ...
            modelBuilder.Entity("StonePizza.Models.PizzaTopping", b =>
                {
                    ...
                    b.HasOne("StonePizza.Models.SignaturePizza", null)
                        .WithMany("Toppings")
                        .HasForeignKey("SignaturePizzaPizzaId");
                });
